...
:root {
  --primary: #111111;
  --secondary: #f7f0f0;
  --secondary-fading: #aaa9a9;
  --tertiary: #fd7624;
  --fading: #43434491;
  --lighted: #353ffb;
  --lighted-fading: #353ffbcc;
  --default-shadow: 0 4px 3px 0 rgba(255, 255, 255, 0.4);
}
